      ...
      >
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <nav className="hidden items-center gap-1 md:flex">
            ...
            <Link
              href="/garage"
              className="flex items-center gap-1.5 rounded-lg px-4 py-2.5 text-base font-medium text-ds-gray-300 transition-colors hover:text-ds-white"
            >
            ...
            <Link
              href="/quiz"
              className="flex items-center gap-1.5 rounded-lg px-4 py-2.5 text-base font-medium text-ds-red transition-colors hover:text-ds-red-400"
            >
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
