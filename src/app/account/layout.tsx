      ...
      <Container>
        <div className="flex flex-col gap-8 lg:flex-row">
          ...
          <aside className="w-full shrink-0 lg:w-64">
            <div className="mb-6 rounded-2xl border border-white/[0.08] bg-ds-black-charcoal p-5">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-ds-red/20 text-ds-red font-bold text-sm">
                  {user.firstName[0]}
                  {user.lastName[0]}
                </div>
