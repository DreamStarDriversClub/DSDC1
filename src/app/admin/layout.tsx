    ...
    <div className="flex min-h-screen bg-ds-black">
      ...
      <aside className="fixed left-0 top-0 z-40 flex h-full w-56 flex-col border-r border-white/[0.06] bg-ds-black-deepest">
        ...
        <nav className="flex-1 space-y-1 overflow-y-auto px-3 py-4">
          ...
          <SidebarLink href="/admin/blog" label="Blog">
            <BlogIcon />
          </SidebarLink>
          <SidebarLink href="/admin/reviews" label="Reviews">
            <ReviewsIcon />
          </SidebarLink>
          <SidebarLink href="/admin/garage" label="Garage">
            <GarageIcon />
          </SidebarLink>
          <SidebarLink href="/admin/printful" label="Printful">
            <PrintfulIcon />
          </SidebarLink>
